...
public class TestMovieandMovieDataReader {
  ...
  /**
   * This test reads in 3 movies and tests whether the list of movies contains all 3 years of the
   * movies of the source data in any order. It fails if the list returned is missing one or more
   * years or if an exception occurs while reading in the data.
   * 
   * @return true if the test passed, false if it failed
   */
  public boolean testReaderMovieYears() {
    ...
    equalOne = equalOne && (year1.equals(movieList.get(0).getYear())
        || year2.equals(movieList.get(0).getYear()) || year3.equals(movieList.get(0).getYear()));
    // check if second movie has the above years
    equalOne = equalOne && (year1.equals(movieList.get(1).getYear())
        || year2.equals(movieList.get(1).getYear()) || year3.equals(movieList.get(1).getYear()));
    // check if third movie has the above years
    equalOne = equalOne && (year1.equals(movieList.get(2).getYear())
        || year2.equals(movieList.get(2).getYear()) || year3.equals(movieList.get(2).getYear()));
   ...
   * the source data in any order. It fails if the list returned is missing one or more directors or
   * if an exception occurs while reading in the data.
   * 
   * @return true if the test passed, false if it failed
   */
  ...
  public boolean testReaderMovieDirectors() {
    ...
    equalOne = equalOne && (d1.equals(movieList.get(0).getDirector())
        || d2.equals(movieList.get(0).getDirector()) || d3.equals(movieList.get(0).getDirector()));
    // check if second movie has the above Directors
    equalOne = equalOne && (d1.equals(movieList.get(1).getDirector())
        || d2.equals(movieList.get(1).getDirector()) || d3.equals(movieList.get(1).getDirector()));
    // check if third movie has the above Directors
    equalOne = equalOne && (d1.equals(movieList.get(2).getDirector())
        || d2.equals(movieList.get(2).getDirector()) || d3.equals(movieList.get(2).getDirector()));
    // true if the three movies have the right Directors
    return equalOne;
  }

  /**
   * This test reads in 3 movies and tests whether the list of movies contains all the same genres
   * of the source data in any order. It fails if the list returned is missing one or more genres or
   * if an exception occurs while reading in the data.
   * 
   * @return true if the test passed, false if it failed
   */
  public boolean testReaderGenreList() {
    ...
    equalOne = equalOne && (g1.equals(movieList.get(0).getGenres())
        || g2.equals(movieList.get(0).getGenres()) || g3.equals(movieList.get(0).getGenres()));

    // check if second movie has of the above genres
    equalOne = equalOne && (g1.equals(movieList.get(1).getGenres())
        || g2.equals(movieList.get(1).getGenres()) || g3.equals(movieList.get(1).getGenres()));

    // check if third movie has of the above genres
    equalOne = equalOne && (g1.equals(movieList.get(2).getGenres())
        || g2.equals(movieList.get(2).getGenres()) || g3.equals(movieList.get(2).getGenres()));
