...
/**
 * Pair node class that is set up like a linked list to store key-value pairs. Includes getters for
 * keys and values, and setters for changing references to the next and previous key-value pair.
 * 
 */
class PairNodeList<KeyType, ValueType> {
  ...
  /*
   * Constructor for a PairNode object to store a key-value pair.
   * 
  ...
  /*
   * Constructor for a PairNode object to store a key-value pair. Sets next and previous according
   * to parameters.
   *
   * @param key The key to be hashed
   * 
...
/**
 * Class implements the MapADT to create a working hash table. PairNode class is incorporated, which
...
public class HashTableMap<KeyType, ValueType> implements MapADT<KeyType, ValueType> {
  ...
  /*
   * Constructor for creating a hashTableMap object to store a key-value pair. Creates a PairNode
  ...
  /*
   * Private helper method that grows the array when load capacity is met or exceeded. Elements and
   * key-value pairs are copied over and rehashed/stored.
   *
   */
  private void grow() {
  ...
  /*
   * This method adds a new key-value pair to the array. Checks for collisions and does chaining if
   * applicable. If the load capacity is met or exceeded, calls grow() to grow the array.
   *
  ...
  /*
   * This method returns the number of key-value pairs stored in the array.
   *
  ...
  /*
   * This method checks if the given key is already stored in the array.
   *
   * @param key Key to be looked up
   * 
  ...
  /*
   * This method is used to remove a key-value pair. Checks if the given key-value pair is stored in
   * the array and returns null if it isn't.
   *
